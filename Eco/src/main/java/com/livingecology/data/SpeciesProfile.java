...
public final class SpeciesProfile {
    ...
    static {
        ...
        put(SpeciesType.TRADER_LLAMA, ranges(20, 40, 65, 85, 65, 80, 70, 90, 85, 100, 75, 90, 55, 70), List.of(Personality.NORMAL, Personality.PROTECTIVE, Personality.SOCIABLE, Personality.CAUTIOUS), false, 2, 48, 5, BehaviorFamily.PASSIVE_HERD, MovementDomain.LAND, TerritoryStyle.COMMUNITY, FootprintType.NONE, ReproductionMode.NONE, HabitatClass.VILLAGE, ActivityPattern.DIURNAL);
